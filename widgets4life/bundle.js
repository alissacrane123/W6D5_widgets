  ...
  _createClass(Clock, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", {
        "class": "clock"
      }, "Widgets4Life ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null), String(this.state.time.getHours()), ":", String(this.state.time.getMinutes()), ":", String(this.state.time.getSeconds()));
    }
  }]);

  return Clock;
}(react__WEBPACK_IMPORTED_MODULE_0___default.a.Component); // module.exports = Clock; 
